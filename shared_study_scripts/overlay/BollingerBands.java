...
public class BollingerBands extends Study 
{
  ...
  public void initialize(Defaults defaults)
  {
    ...
    sd.addQuickSettings(new SliderDescriptor(TOP_SHIFT, get("LBL_SHIFT"), 0, -999, 999, true, () -> Enums.Icon.SHIFT.get()));
    sd.addQuickSettings(new SliderDescriptor(BOTTOM_PERIOD, get("LBL_BOTTOM_PERIOD"), 20, 1, 9999, true, () -> Enums.Icon.SINE_WAVE.get()));
    sd.addQuickSettings(new SliderDescriptor(BOTTOM_SHIFT, get("LBL_SHIFT"), 0, -999, 999, true, () -> Enums.Icon.SHIFT.get()));
    sd.addQuickSettings(TOP_STD, BOTTOM_STD, Inputs.PATH, Inputs.MIDDLE_PATH, Inputs.FILL);

    var desc = createRD();
    desc.setLabelSettings(TOP_PERIOD, BOTTOM_PERIOD, TOP_STD, BOTTOM_STD);
    desc.setIDSettings(TOP_PERIOD, BOTTOM_PERIOD, TOP_STD, BOTTOM_STD, TOP_SHIFT, BOTTOM_SHIFT, Inputs.INPUT, Inputs.METHOD, Inputs.PATH, Inputs.FILL, Inputs.MIDDLE_PATH);
