...
@StudyHeader(
    ...
    overlay=false,
    studyOverlay=true,
    helpLink="http://www.motivewave.com/studies/absolute_price_oscillator.htm")
public class AbsolutePriceOscillator extends com.motivewave.platform.sdk.study.Study 
{
	enum Values { APO };
  ...
  public void initialize(Defaults defaults)
  {
    ...
    desc.exportValue(new ValueDescriptor(Values.APO, get("LBL_APO"), new String[] {Inputs.INPUT, Inputs.METHOD, Inputs.PERIOD, Inputs.PERIOD2}));
    desc.declarePath(Values.APO, Inputs.PATH);
    desc.declareIndicator(Values.APO, Inputs.IND);
    desc.setRangeKeys(Values.APO);
  ...
  protected void calculate(int index, DataContext ctx)
  {
    ...
    int maxPeriod = Util.max(period, period2);
    ...
    series.setDouble(index, Values.APO, diff);
