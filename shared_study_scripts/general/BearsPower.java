...
/** Bears Power. Developed by Alexander Elder. */
@StudyHeader(
    namespace="com.motivewave", 
    id="BEARS_POWER", 
    rb="com.motivewave.platform.study.nls.strings",
    name="TITLE_BEARS_POWER",
    label="LBL_BEARS_POWER",
    desc="DESC_BEARS_POWER",
    menu="MENU_GENERAL",
    overlay=false,
    studyOverlay=true,
    helpLink="http://www.motivewave.com/studies/bears_power.htm")
public class BearsPower extends com.motivewave.platform.sdk.study.Study 
{
	enum Values { BP };
  ...
  public void initialize(Defaults defaults)
  {
    ...
    desc.exportValue(new ValueDescriptor(Values.BP, get("LBL_BEARS_POWER"), new String[] {Inputs.INPUT, Inputs.METHOD, Inputs.PERIOD}));
  ...
  protected void calculate(int index, DataContext ctx)
  {
    ...
    series.setDouble(index, Values.BP, low - ma);
