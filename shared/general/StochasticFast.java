...
@StudyHeader(
    ...
    studyOverlay=true,
    signals=true,
    helpLink="http://www.motivewave.com/studies/stochastic_fast.htm")
public class StochasticFast extends StochasticFull
{
  @Override
  public void initialize(Defaults defaults)
  {
    ...
    lines.addRow(new PathDescriptor(K_LINE, get("LBL_K_FAST_LINE"), defaults.getLineColor(), 1.5f, null, true, false, true));
    lines.addRow(new PathDescriptor(D_LINE, get("LBL_D_FAST_LINE"), defaults.getRed(), 1.0f, null, true, false, true));
    ...
    indicators.addRow(new IndicatorDescriptor(K_IND, get("LBL_K_FAST_IND"), null, null, false, true, true));
    indicators.addRow(new IndicatorDescriptor(D_IND, get("LBL_D_FAST_IND"), defaults.getRed(), null, false, false, true));
    ...
    desc.exportValue(new ValueDescriptor(Values.P_K, get("LBL_K_FAST"), new String[] {Inputs.PERIOD}));
    desc.exportValue(new ValueDescriptor(Values.P_D, get("LBL_D_FAST"), new String[] {Inputs.PERIOD, Inputs.PERIOD3}));
  ...
  @Override
  protected int getKPPeriod() { return 1; }
